...
const strings = new LocalizedStrings({
  fr: {
    ...
    STEP_AUTH: 'Identification',
    STEP_BOOKING: 'Détails',
    STEP_REVIEW: 'Récapitulatif',
    STEP_AUTH_TITLE: 'Connectez-vous ou créez un compte',
    STEP_AUTH_SUBTITLE: 'Vous devez être connecté pour continuer',
    NEXT: 'Suivant',
    BACK: 'Retour',
    PLEASE_SIGN_IN: 'Veuillez vous connecter ou créer un compte pour continuer',
    AUTHENTICATION_REQUIRED: 'Identification requise',
    AUTHENTICATION_REQUIRED_MESSAGE: 'Vous devez vous connecter ou créer un compte pour réserver un véhicule.',
  },
  en: {
    ...
    STEP_AUTH: 'Sign In',
    STEP_BOOKING: 'Details',
    STEP_REVIEW: 'Review',
    STEP_AUTH_TITLE: 'Sign in or create an account',
    STEP_AUTH_SUBTITLE: 'You must be signed in to continue',
    NEXT: 'Next',
    BACK: 'Back',
    PLEASE_SIGN_IN: 'Please sign in or create an account to continue',
    AUTHENTICATION_REQUIRED: 'Authentication required',
    AUTHENTICATION_REQUIRED_MESSAGE: 'You must be signed in to book a vehicle.',
  },
    BOOKING_OPTIONS: 'Your booking options',
    BOOKING_DETAILS: 'Your booking details',
    DAYS: 'Days',
